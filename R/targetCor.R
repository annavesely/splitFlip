...
#' @usage targetCor(X, Y, target = NULL)
...
#' @return \code{targetCor} returns a numeric vector containing the indices of the selected variables.
#' @author Anna Vesely.
#' @examples
...
targetCor <- function(X, Y, target=NULL){
